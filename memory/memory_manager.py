    ...
    def record_evaluation(
        ...
        *,
        ...
        record = build_evaluation_record(
            student_input=str(state.get("student_input") or state.get("report_text") or ""),
            ...
            group_project_results=state.get("group_project_results"),
            dimension_summary=state.get("dimension_summary"),
            primary_indicator_summary=state.get("primary_indicator_summary"),
            ...
            section_target=state.get("section_target"),
